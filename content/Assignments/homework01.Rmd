...
[Obtain the Github repository you will use to complete the mini-assignment][github-classroom-repo], which contains a starter RMarkdown file named `homework_1.Rmd`, which you will use to do your work and write-up when completing the questions below.
...
[univariate-distribution-summary]: /Materials/describing-univariate-and-bivariate-data.html
