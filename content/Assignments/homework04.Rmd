...
[Obtain the Github repository you will use to complete homework 4][github-classroom] that contains a starter RMarkdown file named [homework_3.Rmd]{.monospace}, which you will use to do your work and write-up when completing the questions below.
