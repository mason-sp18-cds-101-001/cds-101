...
Tags: homework
Slug: homework-3
Summary: For this homework assignment, you will practice using the <span class="monospace">SelectorGadget</span> Chrome extension to find the CSS selectors needed to scrape information from a webpage and use the <span class="monospace">rvest</span> package to scrape data from the official Mason Patriots sports website.
Show_summary: true
Show_link: true
...
For this homework assignment, you will practice using the [[SelectorGadget]{.monospace} Chrome extension][selectorgadget-extension] to find the CSS selectors needed to scrape information from a webpage and use the `rvest` package to scrape data from the [official Mason Patriots sports website][mason-sports-site].
